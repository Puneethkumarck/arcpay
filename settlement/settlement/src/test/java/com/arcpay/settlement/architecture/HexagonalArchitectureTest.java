...
@AnalyzeClasses(packages = "com.arcpay.settlement", importOptions = ImportOption.DoNotIncludeTests.class)
class HexagonalArchitectureTest {
    ...
    static final ArchRule settlement_carries_no_policy_business_logic = noClasses()
            ...
            .should()
            .dependOnClassesThat()
            .resideInAnyPackage("com.arcpay.policy..", "com.arcpay.compliance..");

    @ArchTest
    static final ArchRule domain_should_not_define_state_machine_types =
            noClasses().that().resideInAPackage(BASE + ".domain..").should().haveSimpleNameContaining("StateMachine");
