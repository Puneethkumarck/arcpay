...
public final class ErrorMessages {
    ...
    public static final String WALLET_ADDRESS_INVALID =
    ...
    public static final String POLICY_HASH_INVALID =
            "Invalid policy hash: must start with 0x followed by 64 hex characters";
