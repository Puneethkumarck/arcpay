...
@AnalyzeClasses(packages = "com.arcpay.compliance", importOptions = ImportOption.DoNotIncludeTests.class)
class HexagonalArchitectureTest {
    ...
    static final ArchRule rest_controller_only_in_application_controller = noClasses()
            .that()
            .resideOutsideOfPackage(BASE + ".application.controller..")
            .should()
            .beAnnotatedWith(org.springframework.web.bind.annotation.RestController.class);
    ...
    static final ArchRule kafka_listener_only_in_application = noMethods()
            ...
            .should()
            .beAnnotatedWith(org.springframework.kafka.annotation.KafkaListener.class);
