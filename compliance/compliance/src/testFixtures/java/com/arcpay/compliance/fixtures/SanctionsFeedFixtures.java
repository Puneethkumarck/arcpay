...
public final class SanctionsFeedFixtures {
    ...
    public static final Set<String> EXPECTED_OFAC_SDN_ADDRESSES =
            Set.of("0xa1b2c3d4e5f60718293a4b5c6d7e8f9001122334", "0xffffffffffffffffffffffffffffffffffffffff");

    public static final Set<String> EXPECTED_OFAC_NONSDN_ADDRESSES =
            Set.of("0x1122334455667788990011223344556677889900");
