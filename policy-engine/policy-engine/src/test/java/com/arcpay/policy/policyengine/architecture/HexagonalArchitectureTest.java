...
@AnalyzeClasses(packages = "com.arcpay.policy.policyengine", importOptions = ImportOption.DoNotIncludeTests.class)
class HexagonalArchitectureTest {
    ...
    static final ArchRule kafka_listener_only_in_application_stream = noMethods()
            .that()
            .areDeclaredInClassesThat()
            .resideOutsideOfPackage(BASE + ".application.stream..")
            .should()
    ...
    private static final ArchCondition<JavaClass> DECLARE_TOPIC_CONSTANT =
            new ArchCondition<>("declare a public static final String TOPIC field") {
                ...
                public void check(JavaClass clazz, ConditionEvents events) {
                    boolean hasTopic = clazz.getFields().stream()
    ...
    void jpaEntitiesShouldBeSuffixedWithEntity() {
        ...
        List<String> names =
                entities.stream().map(BeanDefinition::getBeanClassName).toList();
