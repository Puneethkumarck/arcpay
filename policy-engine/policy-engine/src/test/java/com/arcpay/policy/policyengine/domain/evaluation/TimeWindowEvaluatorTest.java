...
class TimeWindowEvaluatorTest {
    ...
    class Evaluate {
        ...
        void shouldPassWithinTimeWindow() {
            ...
            var rule = new PolicyRule.TimeWindow(
                    9,
                    17,
                    Set.of(
                            DayOfWeek.MONDAY,
                            ...
                            DayOfWeek.THURSDAY,
                            DayOfWeek.FRIDAY));
            var context = contextWith(new BigDecimal("50.00"), "0xrecipient").toBuilder()
        ...
        void shouldFailOutsideAllowedHours() {
            ...
            var expected = RuleEvaluationResult.builder()
                    ...
                    .message(
                            "Transaction outside allowed time window (9-17 UTC, [MONDAY, TUESDAY, WEDNESDAY, THURSDAY, FRIDAY])")
                    .build();
