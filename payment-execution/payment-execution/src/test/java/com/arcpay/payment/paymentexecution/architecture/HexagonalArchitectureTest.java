package com.arcpay.payment.paymentexecution.architecture;
...
@AnalyzeClasses(packages = "com.arcpay.payment.paymentexecution", importOptions = ImportOption.DoNotIncludeTests.class)
class HexagonalArchitectureTest {

    private static final String BASE = "com.arcpay.payment.paymentexecution";
    ...
    static final ArchRule domain_only_uses_allowed_spring_packages = classes()
            ...
            .resideInAPackage(BASE + ".domain..")
            .should()
            .onlyDependOnClassesThat(JavaClass.Predicates.resideOutsideOfPackage("org.springframework..")
    ...
    static final ArchRule production_code_does_not_use_autowired = noClasses()
            .that()
            .resideInAnyPackage(BASE + ".application..", BASE + ".domain..", BASE + ".infrastructure..")
            .should()
            .dependOnClassesThat()
    ...
    static final ArchRule domain_port_adapters_should_be_package_private = classes()
            ...
            .areNotInterfaces()
            .and()
            .implement(JavaClass.Predicates.resideInAPackage(BASE + ".domain.port.."))
            .should()
            .notBePublic();

    @ArchTest
    static final ArchRule temporal_impls_should_be_package_private = classes()
            .that()
            .resideInAPackage(BASE + ".infrastructure.temporal..")
            .and()
            .areNotInterfaces()
            .and()
    ...
    static final ArchRule adapters_should_be_suffixed = classes()
            .that()
            .resideInAPackage(BASE + ".infrastructure.db..")
            .and()
    ...
    static final ArchRule repository_ports_should_be_suffixed = classes()
            .that()
            .resideInAPackage(BASE + ".domain.port..")
            .and()
            .areInterfaces()
            .and()
            .haveSimpleNameContaining("Repository")
    ...
    @ArchTest
    static final ArchRule port_interfaces_should_be_suffixed = classes()
            .that()
            .resideInAPackage(BASE + ".domain.port..")
            .and()
            .areInterfaces()
    ...
    static final ArchRule controllers_should_be_rest_controllers_and_validated = classes()
            ...
            .andShould()
            .beAnnotatedWith(org.springframework.validation.annotation.Validated.class);
    ...
    static final ArchRule entity_annotation_only_in_infrastructure_db = noClasses()
            .that()
            .resideOutsideOfPackage(BASE + ".infrastructure.db..")
            .should()
            .beAnnotatedWith(jakarta.persistence.Entity.class);

    @ArchTest
    static final ArchRule web3j_confined_to_infrastructure_and_domain_hashing = noClasses()
            .that()
            .resideInAPackage(BASE + ".application..")
            .should()
            .dependOnClassesThat()
            .resideInAPackage("org.web3j..");

    @ArchTest
    static final ArchRule rest_client_confined_to_infrastructure = noClasses()
            .that()
            .resideInAnyPackage(BASE + ".application..", BASE + ".domain..")
            .should()
            .dependOnClassesThat()
            .haveFullyQualifiedName("org.springframework.web.client.RestClient");

    @ArchTest
    static final ArchRule payment_does_not_depend_on_settlement_internal_business_logic = noClasses()
            .that()
            .resideInAnyPackage(BASE + ".application..", BASE + ".domain..", BASE + ".infrastructure..")
            .should()
            .dependOnClassesThat()
            .resideInAnyPackage("com.arcpay.settlement.application..", "com.arcpay.settlement.infrastructure..");
    ...
    private static final ArchCondition<JavaClass> DECLARE_TOPIC_CONSTANT =
            new ArchCondition<>("declare a public static final String TOPIC field") {
                ...
                public void check(JavaClass clazz, ConditionEvents events) {
                    var hasTopic = clazz.getFields().stream()
                            .anyMatch(HexagonalArchitectureTest::isPublicStaticFinalStringTopic);
    ...
    @ArchTest
    static final ArchRule event_topic_fields_should_be_public_static_final_string = fields().that()
            .haveName("TOPIC")
            .and()
            .areDeclaredInClassesThat()
            .resideInAPackage(BASE + ".domain.event..")
