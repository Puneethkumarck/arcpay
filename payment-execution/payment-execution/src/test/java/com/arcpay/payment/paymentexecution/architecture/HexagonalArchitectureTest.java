...
@AnalyzeClasses(
        packages = "com.arcpay.payment.paymentexecution",
...
class HexagonalArchitectureTest {
    ...
    static final ArchRule temporal_impls_should_be_package_private = classes()
            .that().resideInAPackage(BASE + ".infrastructure.temporal..")
    ...
    static final ArchRule port_interfaces_should_be_suffixed = classes()
            .that().resideInAPackage(BASE + ".domain.port..")
            .and().areInterfaces()
            .and().haveSimpleNameContaining("Port")
    ...
    static final ArchRule payment_does_not_depend_on_settlement_internal_business_logic = noClasses()
            ...
            .should().dependOnClassesThat().resideInAnyPackage(
                    "com.arcpay.settlement.application..",
                    "com.arcpay.settlement.infrastructure..");
